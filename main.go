...
func main() {
	...
	// 	Email:    "ryansaputro52@gmail.coms",
	// 	Password: "test123",
	// }

	// userFindByEmail, err := userService.Login(input)
	// if err != nil {
	// 	fmt.Println("ups terjadi kesalahan")
	// 	fmt.Println(err.Error)
	// }

	// fmt.Println(userFindByEmail.Email)
	// fmt.Println(userFindByEmail.Name)
